...
using Ticketer.Message.Core.ContributorAggregate.Events;

namespace Ticketer.Message.Core.ContributorAggregate.Handlers;

/// <summary>
///     NOTE: Internal because ContributorDeleted is also marked as internal.
/// </summary>
internal class ContributorDeletedHandler
    (ILogger<ContributorDeletedHandler> _logger) : INotificationHandler<ContributorDeletedEvent>
{
