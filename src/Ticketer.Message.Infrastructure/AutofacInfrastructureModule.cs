...
public class AutofacInfrastructureModule : Module
{
    ...
    private void LoadAssemblies()
    {
        ...
        var useCasesAssembly = Assembly.GetAssembly(typeof(CreateMessageCommand));
    ...
    {
        builder.RegisterType<ListMessagesQueryService>()
            .As<IListMessagesQueryService>()
            .InstancePerLifetimeScope();
    }
